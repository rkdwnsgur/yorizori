...
Do not output anything other than the JSON object. All text fields in the JSON must be in Korean.`
  ...
  const VERIFIED_RECIPE_DB = [
    ...
    },
    {
      name: '이연복 목란 마파두부',
      source: '이연복 셰프 (목란)',
      requiredIngredients: ['두부', '다진돼지고기', '고추기름'],
      allIngredients: ['두부 1모', '다진 돼지고기 100g', '대파 1/2대', '두반장 1.5스푼', '굴소스 1스푼', '설탕 1스푼', '전분물 2스푼', '고추기름 2스푼'],
      instructions: [
        '두부는 한 입 크기로 깍둑썰고 대파는 잘게 송송 썰어 줍니다.',
        '팬에 고추기름 2스푼을 두르고 대파와 다진 돼지고기를 볶습니다.',
        '고기가 익으면 두반장 1.5스푼과 굴소스 1스푼, 설탕 1스푼을 섞고 물 1컵을 붓습니다.',
        '두부를 냄비에 넣고 소스가 두부에 잘 배도록 중불에서 보글보글 끓입니다.',
        '마지막에 녹말물(전분 1 : 물 2)을 부어 소스 농도를 걸쭉하게 졸여 냅니다.'
      ],
      savingsAmount: 7000
    },
    {
      name: '최현석 들기름 카펠리니',
      source: '최현석 셰프',
      requiredIngredients: ['들기름', '파스타', '면', '깻잎'],
      allIngredients: ['카펠리니 면(혹은 소면) 1인분', '들기름 3스푼', '쯔유 2스푼', '깻잎 5장', '김가루 약간'],
      instructions: [
        '깻잎은 흐르는 물에 씻어 가늘고 곱게 채 썰어 줍니다.',
        '끓는 물에 소면이나 카펠리니 면을 삶은 후 즉시 찬물에 헹구어 차갑게 식힙니다.',
        '물기를 완전히 뺀 면에 들기름 3스푼과 쯔유 2스푼을 넣어 골고루 비벼 간을 합니다.',
        '그릇에 면을 돌돌 말아 담고 그 위에 썰어둔 깻잎채와 김가루를 얹어 상큼하게 냅니다.'
      ],
      savingsAmount: 5500
    },
    {
      name: '고든 램지 정통 카르보나라',
      source: '고든 램지 클래스',
      requiredIngredients: ['베이컨', '달걀', '계란', '치즈'],
      allIngredients: ['스파게티 면 1인분', '베이컨 3장', '계란 노른자 2개', '파마산 치즈가루 3스푼', '마늘 2알', '올리브유', '후추'],
      instructions: [
        '마늘은 얇게 썰고 베이컨은 한 입 크기로 썰어 팬에 바삭하게 볶습니다.',
        '볼에 계란 노른자 2개와 파마산 치즈가루, 후추를 섞어 소스를 개어 둡니다.',
        '삶아진 스파게티 면을 베이컨 팬에 넣고 면수 반 국수와 함께 볶습니다.',
        '팬의 불을 완전히 끈 후 잠시 식혔다가 볼의 계란 치즈 소스를 붓고 빠르게 섞어 소스를 유화시킵니다.'
      ],
      savingsAmount: 9000
    },
    {
      name: '성시경 투움바 신라면',
      source: '성시경의 레시피',
      requiredIngredients: ['라면', '우유', '치즈'],
      allIngredients: ['신라면 1개', '우유 250ml', '체다치즈 2장', '양파 1/2개', '베이컨 2장', '라면스프 1/2개'],
      instructions: [
        '양파와 베이컨을 가늘게 채 썰어 기름을 두른 팬에 노릇하게 볶아 줍니다.',
        '팬에 우유 250ml와 체다치즈 2장, 라면 분말스프 1/2봉을 넣어 약불에 끓입니다.',
        '다른 냄비에 면을 2분간 꼬들하게 삶아 건진 뒤 우유 소스 팬에 투하합니다.',
        '우유 소스가 면에 쏙 베어 걸쭉해질 때까지 1~2분간 가볍게 졸여 담아 냅니다.'
      ],
      savingsAmount: 4800
    },
    {
      name: '이연복 토마토 달걀 볶음',
      source: '이연복 셰프',
      requiredIngredients: ['토마토', '달걀', '계란'],
      allIngredients: ['토마토 1개 (혹은 방울토마토 8개)', '달걀 2개', '대파 1/4대', '굴소스 1스푼', '식용유'],
      instructions: [
        '토마토는 한 입 크기로 조각 썰고 대파는 쫑쫑 썰어 줍니다.',
        '팬에 기름을 두르고 소금을 넣고 푼 달걀을 넣어 스크램블을 만들어 덜어둡니다.',
        '팬에 기름을 보충하고 대파를 볶아 향을 낸 뒤 썰어둔 토마토를 넣고 충분히 볶습니다.',
        '토마토가 부드러워지면 굴소스 1스푼과 스크램블 에그를 넣고 강불에서 가볍게 뒤섞어 완성합니다.'
      ],
      savingsAmount: 3500
    },
    {
      name: '류수영 닭가슴살 볶음밥',
      source: '편스토랑 류수영',
      requiredIngredients: ['닭가슴살'],
      allIngredients: ['닭가슴살 1덩이 (100g)', '밥 1공기', '대파 1/2대', '진간장 1스푼', '굴소스 1스푼', '참기름 1스푼', '식용유'],
      instructions: [
        '닭가슴살은 결을 따라 가위나 손으로 먹기 좋게 잘게 찢어 둡니다.',
        '팬에 기름을 적당히 두르고 대파를 볶아 향이 풍부한 파기름을 냅니다.',
        '찢어둔 닭가슴살을 넣어 같이 볶다가 굴소스 1스푼, 간장 1스푼을 넣어 밑간을 합니다.',
        '찬밥 1공기를 넣고 주걱으로 잘 고슬고슬하게 버무려 볶아 줍니다.',
        '마지막에 참기름을 두르고 불을 꺼 그릇에 정성스레 퍼 담아 완성합니다.'
      ],
      savingsAmount: 4200
    },
    {
      name: '백종원 소고기 무국',
      source: '백종원 요리비책',
      requiredIngredients: ['소고기', '무'],
      allIngredients: ['소고기 국거리용 100g', '무 1/5토막', '대파 1/2대', '국간장 2스푼', '다진 마늘 1스푼', '참기름 1스푼', '물 4컵'],
      instructions: [
        '무는 나박나박 얇게 썰어주고 대파는 송송 썰어 준비합니다.',
        '냄비에 참기름 1스푼을 두른 후 소고기를 넣어 겉면이 익을 때까지 볶습니다.',
        '고기가 노릇해지면 무를 넣고 1분간 더 볶아 풍미를 끌어올립니다.',
        '물 4컵을 붓고 끓이다 국간장 2스푼, 다진 마늘 1스푼을 넣고 푹 끓여줍니다.',
        '마지막에 송송 썬 대파를 넣고 한소끔 더 끓여 그릇에 담아 완성합니다.'
      ],
      savingsAmount: 9000
    },
    {
      ...
      allIngredients: ['양배추 1/4통', '버터 1조각(20g)', '올리브유 2스푼', '파마산 치즈가루 약간', '소금', '후추'],
      instructions: [
        '양배추는 잎이 조각나 흩어지지 않게 밑동이 붙어 있도록 삼각형 모양으로 썰어 줍니다.',
        '팬에 올리브유 2스푼을 두르고 소금을 가볍게 친 양배추를 올립니다.',
        '약불에서 양배추 속까지 부드럽게 익도록 앞뒤로 노릇하게 지져 줍니다.',
        '양배추가 나른해졌을 때 버터 1조각을 팬에 녹여 양배추 표면에 향을 고루 입힙니다.',
        '그릇에 옮겨 담은 뒤 후추와 파마산 치즈가루를 듬뿍 뿌려 완성합니다.'
      ],
      savingsAmount: 4800
    }
  ];
  ...
  const fallbackLocalResponse = (userText: string): { text: string; recipe?: Recipe } => {
    ...
    // ----------------------------------------------------
    const targetIngredients = ['오이', '감자', '양파', '달걀', '계란', '대파', '김치', '당근', '두부', '어묵', '오뎅', '스팸', '햄', '돼지고기', '들기름', '파스타', '면', '베이컨', '라면', '우유', '토마토', '닭가슴살', '소고기', '양배추', '무'];
